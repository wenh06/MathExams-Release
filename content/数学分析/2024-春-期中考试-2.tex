...
\fi
2023 $\sim*$ 2024学年春季学期\\
\textbf{\uline{\hspace{0.5cm}数学分析II\hspace{0.5cm}}}课程第二次期中考试试题
}

% \subject{\uline{数学分析II}}
...
\ifShowAnswer
\noindent \textbf{考生诚信承诺}\\
1. \textbf{本人清楚学校关于考试管理、考场规则、考试作弊处理的规定, 并严格遵照执行。}\\
2. \textbf{本人承诺在考试过程中没有作弊行为, 所做试卷的内容真实可信。}\\[6pt]
\textbf{学院：\rule[-0.45mm]{2cm}{0.15mm} \hspace{0.5cm} 班级：\rule[-0.45mm]{2cm}{0.15mm} \hspace{0.5cm} 学号：\rule[-0.45mm]{3cm}{0.15mm} \hspace{0.5cm} 姓名：\rule[-0.45mm]{2cm}{0.15mm}
}
\else
% do nothing
\fi
